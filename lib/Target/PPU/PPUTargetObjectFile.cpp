//===-- PPUTargetObjectFile.cpp - PPU Object Info -----------------===//
//
...
void PPUELFTargetObjectFile::Initialize(MCContext &Ctx,
...
bool PPUELFTargetObjectFile::isInSmallSection(uint64_t Size) const {
...
// section.
bool PPUELFTargetObjectFile::isGlobalInSmallSection(
...
MCSection *PPUELFTargetObjectFile::SelectSectionForGlobal(
...
void PPUELFTargetObjectFile::getModuleMetadata(Module &M) {
...
bool PPUELFTargetObjectFile::isConstantInSmallSection(
    const DataLayout &DL, const Constant *CN) const {
  return isInSmallSection(DL.getTypeAllocSize(CN->getType()));
}

MCSection *PPUELFTargetObjectFile::getSectionForConstant(
