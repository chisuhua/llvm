//===- PPUDisassembler.hpp - Disassembler for PPU ISA -----*- C++ -*-===//
//
...
/// \file
///
/// This file contains declaration for PPU ISA disassembler
//
//===----------------------------------------------------------------------===//

#ifndef LLVM_LIB_TARGET_PPU_DISASSEMBLER_PPUDISASSEMBLER_H
#define LLVM_LIB_TARGET_PPU_DISASSEMBLER_PPUDISASSEMBLER_H
...
public:
  ...
  ~PPUDisassembler() override = default;
...
//  DecodeStatus convertMIMGInst(MCInst &MI) const;
  ...
  MCOperand decodeOperand_VPR_32(unsigned Val) const;
...
class PPUSymbolizer : public MCSymbolizer {
private:
  void *DisInfo;

public:
  PPUSymbolizer(MCContext &Ctx, std::unique_ptr<MCRelocationInfo> &&RelInfo,
                   void *disInfo)
...
#endif // LLVM_LIB_TARGET_PPU_DISASSEMBLER_PPUDISASSEMBLER_H
