//===- PPUPerfHintAnalysis.h ---- analysis of memory traffic -*- C++ -*-===//
//
...
#ifndef LLVM_LIB_TARGET_PPU_MDGPUPERFHINTANALYSIS_H
#define LLVM_LIB_TARGET_PPU_MDGPUPERFHINTANALYSIS_H
...
struct PPUPerfHintAnalysis : public CallGraphSCCPass {
  static char ID;

public:
  PPUPerfHintAnalysis() : CallGraphSCCPass(ID) {}
...
#endif // LLVM_LIB_TARGET_PPU_MDGPUPERFHINTANALYSIS_H
