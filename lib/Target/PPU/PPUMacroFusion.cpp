//===--- PPUMacroFusion.cpp - PPU Macro Fusion ----------------------===//
//
...
//===----------------------------------------------------------------------===//
//
/// \file This file contains the PPU implementation of the DAG scheduling
...
static bool shouldScheduleAdjacent(const TargetInstrInfo &TII_,
  ...
  const PPUInstrInfo &TII = static_cast<const PPUInstrInfo&>(TII_);
...
std::unique_ptr<ScheduleDAGMutation> createPPUMacroFusionDAGMutation () {
