...
// static bool PPUAsmParser::classifySymbolRef(const MCExpr *Expr,
...
public:
  PPUOperand(KindTy Kind_, const PPUAsmParser *AsmParser_ = nullptr)
...
public:
  ...
  bool isSCSrcB8() const {
    return isRegOrInlineNoMods(PPU::SReg_32RegClassID, MVT::i8);
  }
  ...
  bool isVCSrcB8() const {
    return isRegOrInlineNoMods(PPU::VS_32RegClassID, MVT::i8);
  }
