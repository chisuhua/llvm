...
class PPUOperand : public MCParsedAsmOperand {
  enum class KindTy {
    Token,
    Immediate,
    Register,
  ...
  const PPUAsmParser *AsmParser;

public:
  PPUOperand(KindTy Kind_, const PPUAsmParser *AsmParser_)
  ...
  PPUOperand(const PPUOperand &o) : MCParsedAsmOperand() {
    ...
    case KindTy::Expression:
      llvm_unreachable("PPUOperand ctr wip");
      break;
    }
  }

  using Ptr = std::unique_ptr<PPUOperand>;
  ...
  struct Modifiers {
    ...
    int64_t getFPModifiersOperand() const {
      int64_t Operand = 0;
      Operand |= Abs ? PPUSrcMods::ABS : 0u;
      Operand |= Neg ? PPUSrcMods::NEG : 0u;
      return Operand;
    }

    int64_t getIntModifiersOperand() const {
      int64_t Operand = 0;
      Operand |= Sext ? PPUSrcMods::SEXT : 0u;
      return Operand;
    }
    ...
    friend raw_ostream &operator <<(raw_ostream &OS, PPUOperand::Modifiers Mods);
  };
...
public:
  ...
  bool isRegOrImmWithInt16InputMods() const {
    return isRegOrImmWithInputMods(PPU::VS_32RegClassID, MVT::i16);
  }

  bool isRegOrImmWithInt32InputMods() const {
    return isRegOrImmWithInputMods(PPU::VS_32RegClassID, MVT::i32);
  }

  bool isRegOrImmWithInt64InputMods() const {
    return isRegOrImmWithInputMods(PPU::VS_64RegClassID, MVT::i64);
  }

  bool isRegOrImmWithFP16InputMods() const {
    return isRegOrImmWithInputMods(PPU::VS_32RegClassID, MVT::f16);
  }

  bool isRegOrImmWithFP32InputMods() const {
    return isRegOrImmWithInputMods(PPU::VS_32RegClassID, MVT::f32);
  }

  bool isRegOrImmWithFP64InputMods() const {
    return isRegOrImmWithInputMods(PPU::VS_64RegClassID, MVT::f64);
  }
  ...
  bool isVReg() const {
    return isRegClass(PPU::VPR_32RegClassID) ||
           ...
           isRegClass(PPU::VReg_1024RegClassID);*/
  }
  ...
  bool isSCSrcB16() const {
    return isRegOrInlineNoMods(PPU::SReg_32RegClassID, MVT::i16);
  }
  ...
  bool isSCSrcB32() const {
    return isRegOrInlineNoMods(PPU::SReg_32RegClassID, MVT::i32);
  }

  bool isSCSrcB64() const {
    return isRegOrInlineNoMods(PPU::SReg_64RegClassID, MVT::i64);
  }

  bool isBoolReg() const;

  bool isSCSrcF16() const {
    return isRegOrInlineNoMods(PPU::SReg_32RegClassID, MVT::f16);
  }
  ...
  bool isSCSrcF32() const {
    return isRegOrInlineNoMods(PPU::SReg_32RegClassID, MVT::f32);
  }

  bool isSCSrcF64() const {
    return isRegOrInlineNoMods(PPU::SReg_64RegClassID, MVT::f64);
  }
  ...
  bool isSSrcOrLdsB32() const {
    return isRegOrInlineNoMods(PPU::SRegOrLds_32RegClassID, MVT::i32) ||
           isLiteralImm(MVT::i32) || isExpr();
  }

  bool isVCSrcB32() const {
    return isRegOrInlineNoMods(PPU::VS_32RegClassID, MVT::i32);
  }

  bool isVCSrcB64() const {
    return isRegOrInlineNoMods(PPU::VS_64RegClassID, MVT::i64);
  }

  bool isVCSrcB16() const {
    return isRegOrInlineNoMods(PPU::VS_32RegClassID, MVT::i16);
  }
  ...
  bool isVCSrcF32() const {
    return isRegOrInlineNoMods(PPU::VS_32RegClassID, MVT::f32);
  }

  bool isVCSrcF64() const {
    return isRegOrInlineNoMods(PPU::VS_64RegClassID, MVT::f64);
  }

  bool isVCSrcF16() const {
    return isRegOrInlineNoMods(PPU::VS_32RegClassID, MVT::f16);
  }
  ...
  bool isVISrcB32() const {
    return isRegOrInlineNoMods(PPU::VPR_32RegClassID, MVT::i32);
  }

  bool isVISrcB16() const {
    return isRegOrInlineNoMods(PPU::VPR_32RegClassID, MVT::i16);
  }
  ...
  bool isVISrcF32() const {
    return isRegOrInlineNoMods(PPU::VPR_32RegClassID, MVT::f32);
  }

  bool isVISrcF16() const {
    return isRegOrInlineNoMods(PPU::VPR_32RegClassID, MVT::f16);
  }
...
/*
  bool isAISrcB32() const {
    return isRegOrInlineNoMods(PPU::AGPR_32RegClassID, MVT::i32);
  }

  bool isAISrcB16() const {
    return isRegOrInlineNoMods(PPU::AGPR_32RegClassID, MVT::i16);
  }
  ...
  bool isAISrcF32() const {
    return isRegOrInlineNoMods(PPU::AGPR_32RegClassID, MVT::f32);
  }

  bool isAISrcF16() const {
    return isRegOrInlineNoMods(PPU::AGPR_32RegClassID, MVT::f16);
  }
  ...
  bool isAISrc_128B32() const {
    return isRegOrInlineNoMods(PPU::AReg_128RegClassID, MVT::i32);
  }

  bool isAISrc_128B16() const {
    return isRegOrInlineNoMods(PPU::AReg_128RegClassID, MVT::i16);
  }
  ...
  bool isAISrc_128F32() const {
    return isRegOrInlineNoMods(PPU::AReg_128RegClassID, MVT::f32);
  }

  bool isAISrc_128F16() const {
    return isRegOrInlineNoMods(PPU::AReg_128RegClassID, MVT::f16);
  }
  ...
  bool isAISrc_512B32() const {
    return isRegOrInlineNoMods(PPU::AReg_512RegClassID, MVT::i32);
  }

  bool isAISrc_512B16() const {
    return isRegOrInlineNoMods(PPU::AReg_512RegClassID, MVT::i16);
  }
  ...
  bool isAISrc_512F32() const {
    return isRegOrInlineNoMods(PPU::AReg_512RegClassID, MVT::f32);
  }

  bool isAISrc_512F16() const {
    return isRegOrInlineNoMods(PPU::AReg_512RegClassID, MVT::f16);
  }
  ...
  bool isAISrc_1024B32() const {
    return isRegOrInlineNoMods(PPU::AReg_1024RegClassID, MVT::i32);
  }

  bool isAISrc_1024B16() const {
    return isRegOrInlineNoMods(PPU::AReg_1024RegClassID, MVT::i16);
  }
  ...
  bool isAISrc_1024F32() const {
    return isRegOrInlineNoMods(PPU::AReg_1024RegClassID, MVT::f32);
  }

  bool isAISrc_1024F16() const {
    return isRegOrInlineNoMods(PPU::AReg_1024RegClassID, MVT::f16);
  }
...
*/
  ...
  static PPUOperand::Ptr CreateImm(const PPUAsmParser *AsmParser,
                                      int64_t Val, SMLoc Loc,
                                      ImmTy Type = ImmTyNone,
                                      bool IsFPImm = false) {
    auto Op = std::make_unique<PPUOperand>(KindTy::Immediate, AsmParser);
    Op->Imm.Val.Int = Val;
  ...
  static PPUOperand::Ptr CreateToken(const PPUAsmParser *AsmParser,
                                        StringRef Str, SMLoc Loc,
                                        bool HasExplicitEncodingSize = true) {
    auto Res = std::make_unique<PPUOperand>(KindTy::Token, AsmParser);
  ...
  static PPUOperand::Ptr CreateReg(const PPUAsmParser *AsmParser,
                                      unsigned RegNo, SMLoc S,
                                      SMLoc E) {
    auto Op = std::make_unique<PPUOperand>(KindTy::Register, AsmParser);
  ...
  static PPUOperand::Ptr CreateExpr(const PPUAsmParser *AsmParser,
                                       const class MCExpr *Expr, SMLoc S) {
    auto Op = std::make_unique<PPUOperand>(KindTy::Expression, AsmParser);
    Op->Expr = Expr;
    Op->StartLoc = S;
    Op->EndLoc = S;
    return Op;
...
// below is from RISCV
  ...
  template <int N> bool isBareSimmNLsb0() const {
    ...
    bool IsValid;
    if (!IsConstantImm)
      IsValid = PPUAsmParser_classifySymbolRef(getImm(), VK, Imm);
    else
  ...
  bool isBareSymbol() const {
    ...
    if (!isImm() || evaluateConstantImm(getImm(), Imm, VK))
      return false;
    return PPUAsmParser_classifySymbolRef(getImm(), VK, Imm) &&
           VK == PPUMCExpr::VK_PPU_None;
  }
...
/* AMD */
  ...
  bool isPPT() const { return getSTI().hasFeature(PPU::FeaturePPT); }
...
private:
  ...
  bool AddNextRegisterToList(unsigned& Reg, unsigned& RegWidth,
                             ...
                             unsigned RegNum);
  bool ParsePPURegister(RegisterKind& RegKind, unsigned& Reg,
...
public:
  ...
  */
  ...
  using OptionalImmIndexMap = std::map<PPUOperand::ImmTy, unsigned>;
...
#undef GET_OPERAND_DIAGNOSTIC_TYPES
  ...
  PPUAsmParser(const MCSubtargetInfo &STI, MCAsmParser &_Parser,
  ...
  // below AMD
  bool hasXNACK() const {
    return false; // PPU::hasXNACK(getSTI());
  }

  bool hasMIMG_R128() const {
    return false; // PPU::hasMIMG_R128(getSTI());
  }

  bool hasPackedD16() const {
    return true; // PPU::hasPackedD16(getSTI());
  }

  bool isSI() const {
    return false; // PPU::isSI(getSTI());
  }

  bool isCI() const {
    return false; // PPU::isCI(getSTI());
  }

  bool isVI() const {
    return true; // PPU::isVI(getSTI());
  }

  bool isGFX9() const {
    return true; // PPU::isGFX9(getSTI());
  }

  bool isGFX10() const {
    return true; // PPU::isGFX10(getSTI());
  }

  bool hasInv2PiInlineImm() const {
    return getFeatureBits()[PPU::FeatureInv2PiInlineImm];
  }

  bool hasFlatOffsets() const {
    return getFeatureBits()[PPU::FeatureFlatInstOffsets];
  }
  ...
  bool hasIntClamp() const {
    return getFeatureBits()[PPU::FeatureIntClamp];
  }
/*
  PPUTargetStreamer &getTargetStreamer() {
    MCTargetStreamer &TS = *getParser().getStreamer().getTargetStreamer();
...
*/
  const MCRegisterInfo *getMRI() const {
    ...
    // in MCAsmParser.
    return const_cast<PPUAsmParser*>(this)->getContext().getRegisterInfo();
  }
  ...
  std::unique_ptr<PPUOperand> parseRegister();
  ...
  parseIntWithPrefix(const char *Prefix, OperandVector &Operands,
                     PPUOperand::ImmTy ImmTy = PPUOperand::ImmTyNone,
...
public:
  ...
  PPUOperand::Ptr defaultDLC() const;
  PPUOperand::Ptr defaultGLC() const;
  PPUOperand::Ptr defaultSLC() const;

  PPUOperand::Ptr defaultSMRDOffset8() const;
  PPUOperand::Ptr defaultSMRDOffset20() const;
  PPUOperand::Ptr defaultSMRDLiteralOffset() const;
  PPUOperand::Ptr defaultFlatOffset() const;
  ...
  PPUOperand::Ptr defaultRowMask() const;
  PPUOperand::Ptr defaultBankMask() const;
  PPUOperand::Ptr defaultBoundCtrl() const;
  PPUOperand::Ptr defaultFI() const;
  ...
  PPUOperand::Ptr defaultBLGP() const;
  PPUOperand::Ptr defaultCBSZ() const;
  PPUOperand::Ptr defaultABID() const;

  OperandMatchResultTy parseEndpgmOp(OperandVector &Operands);
  PPUOperand::Ptr defaultEndpgmImmOperands() const;
...
raw_ostream &operator <<(raw_ostream &OS, PPUOperand::Modifiers Mods) {
...
OperandMatchResultTy
PPUAsmParser::parseOperand(OperandVector &Operands, StringRef Mnemonic,
                              OperandMode Mode) {
...
void PPUAsmParser::cvtDSImpl(MCInst &Inst, const OperandVector &Operands,
  ...
  PPUOperand::ImmTy OffsetType =
    (Inst.getOpcode() == PPU::DS_SWIZZLE_B32_ppu) ? PPUOperand::ImmTySwizzle :
...
OperandMatchResultTy PPUAsmParser::parseInterpSlot(OperandVector &Operands) {
  ...
  Parser.Lex();
  Operands.push_back(PPUOperand::CreateImm(this, Slot, S,
                                              PPUOperand::ImmTyInterpSlot));
  return MatchOperand_Success;
}

OperandMatchResultTy PPUAsmParser::parseInterpAttr(OperandVector &Operands) {
  if (getLexer().getKind() != AsmToken::Identifier)
    return MatchOperand_NoMatch;
  ...
  Operands.push_back(PPUOperand::CreateImm(this, Attr, S,
                                              PPUOperand::ImmTyInterpAttr));
  Operands.push_back(PPUOperand::CreateImm(this, AttrChan, SChan,
                                              PPUOperand::ImmTyAttrChan));
  return MatchOperand_Success;
}
...
OperandMatchResultTy
PPUAsmParser::parseGPRIdxMode(OperandVector &Operands) {
...
bool PPUOperand::isGPRIdxMode() const {
...
void PPUAsmParser::cvtVOP3(MCInst &Inst, const OperandVector &Operands,
  ...
  // should be 0.
  if (Opc == PPU::V_MAC_F32_e64_gfx6_gfx7 ||
      Opc == PPU::V_MAC_F32_e64_gfx10 ||
      Opc == PPU::V_MAC_F32_e64_vi ||
      Opc == PPU::V_MAC_F16_e64_vi ||
      Opc == PPU::V_FMAC_F32_e64_gfx10 ||
      Opc == PPU::V_FMAC_F32_e64_vi ||
      Opc == PPU::V_FMAC_F16_e64_gfx10) {
    auto it = Inst.begin();
...
bool PPUAsmParser::ParseInstruction(ParseInstructionInfo &Info,
  ...
  if (isPPT()) return ParseInstruction_ppt();
...
static bool PPUAsmParser_classifySymbolRef(const MCExpr *Expr,
                                ...
                                int64_t &Addend)
{
    return PPUAsmParser::classifySymbolRef(*Expr, Kind, Addend);
}
