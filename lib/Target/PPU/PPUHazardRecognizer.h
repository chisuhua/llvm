//===-- PPUHazardRecognizers.h - PPU Hazard Recognizers ---------*- C++ -*-===//
//
...
//===----------------------------------------------------------------------===//
//
// This file defines hazard recognizers for scheduling on PPU processors.
//
//===----------------------------------------------------------------------===//

#ifndef LLVM_LIB_TARGET_PPUHAZARDRECOGNIZERS_H
#define LLVM_LIB_TARGET_PPUHAZARDRECOGNIZERS_H
...
class PPUHazardRecognizer final : public ScheduleHazardRecognizer {
public:
...
public:
  PPUHazardRecognizer(const MachineFunction &MF);
...
#endif //LLVM_LIB_TARGET_PPUHAZARDRECOGNIZERS_H
