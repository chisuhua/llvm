//===- PPUMetadataVerifier.h - MsgPack Types -----------------*- C++ -*-===//
//
...
//
/// \file
/// This is a verifier for PPU HSA metadata, which can verify both
...
#ifndef LLVM_BINARYFORMAT_PPUMETADATAVERIFIER_H
#define LLVM_BINARYFORMAT_PPUMETADATAVERIFIER_H
...
#endif // LLVM_BINARYFORMAT_PPUMETADATAVERIFIER_H
