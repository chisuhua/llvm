...
//
/// \file
/// PPU metadata definitions and in-memory representations.
///
//
//===----------------------------------------------------------------------===//

#ifndef LLVM_SUPPORT_PPUMETADATA_H
#define LLVM_SUPPORT_PPUMETADATA_H
...
constexpr char AssemblerDirectiveBegin[] = ".ppu_hsa_metadata";
/// HSA metadata ending assembler directive.
constexpr char AssemblerDirectiveEnd[] = ".end_ppu_hsa_metadata";
...
#endif // LLVM_SUPPORT_PPUMETADATA_H
