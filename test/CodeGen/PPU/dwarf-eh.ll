; RUN: llc -march=ppu --code-model=small  < %s \
; RUN:     | FileCheck %s
; RUN: llc -march=ppu --code-model=medium < %s \
; RUN:     | FileCheck %s
; RUN: llc -march=ppu --code-model=small  -relocation-model=pic < %s \
; RUN:     | FileCheck %s
; RUN: llc -march=ppu --code-model=medium -relocation-model=pic < %s \
; RUN:     | FileCheck %s
; RUN:     | FileCheck %s
; RUN:     | FileCheck %s
; RUN:     | FileCheck %s
