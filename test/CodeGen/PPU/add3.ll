...
define amdgpu_cs float @add3(i32 %a, i32 %b) {
; VI-LABEL: add3:
; VI:       ; %bb.0:
...
define amdgpu_cs float @mad_no_add3(i32 %a, i32 %b, i32 %c, i32 %d, i32 %e) {
...
define amdgpu_cs float @add3_vgpr_b(i32 inreg %a, i32 %b, i32 inreg %c) {
...
define amdgpu_cs float @add3_vgpr_all2(i32 %a, i32 %b, i32 %c) {
...
define amdgpu_cs float @add3_vgpr_bc(i32 inreg %a, i32 %b, i32 %c) {
...
define amdgpu_cs float @add3_vgpr_const(i32 %a, i32 %b) {
