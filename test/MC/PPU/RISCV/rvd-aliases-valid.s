# RUN: llvm-mc %s -triple=ppu -mattr=+d -ppu-no-aliases \
# RUN:     | FileCheck -check-prefix=CHECK-INST %s
# RUN: llvm-mc %s -triple=ppu -mattr=+d \
# RUN:     | FileCheck -check-prefix=CHECK-ALIAS %s
# RUN:     | FileCheck -check-prefix=CHECK-INST %s
# RUN:     | FileCheck -check-prefix=CHECK-ALIAS %s
# RUN: llvm-mc -filetype=obj -triple ppu -mattr=+d < %s \
# RUN:     | llvm-objdump -d -mattr=+d -ppu-no-aliases - \
# RUN:     | FileCheck -check-prefix=CHECK-INST %s
# RUN: llvm-mc -filetype=obj -triple ppu -mattr=+d < %s \
