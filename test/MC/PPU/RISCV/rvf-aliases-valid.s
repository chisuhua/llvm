# RUN: llvm-mc %s -triple=ppu -mattr=+f -ppu-no-aliases \
# RUN:     | FileCheck -check-prefix=CHECK-INST %s
# RUN: llvm-mc %s -triple=ppu -mattr=+f \
# RUN:     | FileCheck -check-prefix=CHECK-ALIAS %s
# RUN:     | FileCheck -check-prefix=CHECK-INST %s
# RUN:     | FileCheck -check-prefix=CHECK-ALIAS %s
# RUN: llvm-mc -filetype=obj -triple ppu -mattr=+f < %s \
# RUN:     | llvm-objdump -d -mattr=+f -ppu-no-aliases - \
# RUN:     | FileCheck -check-prefix=CHECK-INST %s
# RUN: llvm-mc -filetype=obj -triple ppu -mattr=+f < %s \
