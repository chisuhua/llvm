; RUN: llc -filetype=obj -mtriple=ppu -mattr=+relax %s -o - \
...
; RELAX-NOT: {{[}]}}
; RELAX-NOT: 0x0 R_PPU_ADD32
; RELAX-NOT: 0x0 R_PPU_SUB32
; RELAX-NOT: {{[}]}}
; RELAX: 0x20 R_PPU_ADD32
; RELAX: 0x20 R_PPU_SUB32
; RELAX-NOT: {{[}]}}
; RELAX: 0x25 R_PPU_SET6
; RELAX: 0x25 R_PPU_SUB6
;
; RELAX-DWARFDUMP: CIE
